...
- (IBAction)readZXingObjC:(id)sender {
    ZXingViewController *zxingView = [self.storyboard instantiateViewControllerWithIdentifier:@"ZXingView"];
    [self presentViewController:zxingView animated:YES completion:nil];
}

- (IBAction)readMBProgressHUD:(id)sender {
    MBProgressViewController *mbView = [self.storyboard instantiateViewControllerWithIdentifier:@"MBProgressView"];
    [self presentViewController:mbView animated:YES completion:nil];
}
